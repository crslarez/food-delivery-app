...
const Products = () => {
  const { restaurantes, setRestaurantes, restaurante, FilterProducts } =
    useContext(Context);
  return (
    <div className="main">
      <div className="login bg-white h-screen flex justify-between flex-col max-w-md mx-auto p-5 py-20 ">
        ...
        <p className="ml-5  text-2xl font-medium mt-10">
          Restaurants and Coofies
        </p>

        <div className="flex flex-wrap  w-200 mb-2 ">
          <button className="bg-gray-400 w-20 h-8 m-1 mr-1 rounded text-xs hover:bg-yellow-300">
            All
          </button>

          <button
            onClick={FilterProducts}
            className="bg-gray-400 w-20 h-8 m-1 mr-1 rounded text-xs hover:bg-yellow-300 "
          >
            <i className="fa-solid fa-bowl-food btn-filter__icon"></i>Arroz
          </button>
          <button className="bg-gray-400 w-20 h-8 m-1 mr-1 rounded text-xs hover:bg-yellow-300 ">
            <i className="fa-solid fa-drumstick-bite btn-filter__icon"></i>Pollo
          </button>
          <button className="bg-gray-400 w-20 h-8 m-1 mr-1 rounded text-xs hover:bg-yellow-300 ">
            <i className="fa-solid fa-utensils btn-filter__icon"></i>Sopa
          </button>
        </div>
        <div>
